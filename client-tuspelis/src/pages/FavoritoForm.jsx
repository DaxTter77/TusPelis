        ...
        Añade un Favorito
            <div className="container text-xl bg-gray-700 px-3 rounded-md py-5">
                ...
                grid grid-cols-[2fr_1fr_2fr] gap-4 ">
                    ...
                    <br />
                    <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer col-start-3 row-start-2"
                        type="file" 
                        accept="image/*"
